...
def process_data():
    ...
    test_dpm.load_task1("test.tsv")
    test_df = test_dpm.train_task1_df
    
    # analysis
    test_df = test_df[test_df.orig_label=="4"]
    
    test_dataset = IncontextUtil.data2examples(test_df, pos_df, neg_df)
    references = load_references(test_dataset)
